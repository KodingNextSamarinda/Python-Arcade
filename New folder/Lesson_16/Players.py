...
class PlayerCharacter(arcade.Sprite):
    def __init__(self):
        ...
        self.points = [[-22,-64],[22,-64],[22,64],[-22,64]]

        #load the texture
        simpan_texture = ":resources:images/animated_characters/robot/robot"
    ...
    def update_animation(self, delta_time: float = 1 / 60):
        ...
        if self.change_x < 0 and self.Char_face_direction == FacingRight:
            self.Char_face_direction = FacingLeft
        elif self.change_x > 0 and self.Char_face_direction == FacingLeft:
            self.Char_face_direction = FacingRight